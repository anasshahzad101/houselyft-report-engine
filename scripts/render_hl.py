...
async def main():
    async with async_playwright() as p:
        ...
        await page.goto("file:///home/claude/report_houselyft_master.html", wait_until="networkidle")
        await page.wait_for_timeout(1200)  # let Google Fonts settle
        await page.pdf(
            path="/mnt/user-data/outputs/Property_Report_303_Coxwell_HOUSELYFT.pdf",
            format="Letter",
